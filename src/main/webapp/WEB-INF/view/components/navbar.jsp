...
<nav class="navbar navbar-expand-lg navbar-light custom-bg">
  <a class="navbar-brand" href="/home">
   ...
   <i><b><span class="text-color">EasyWay Bank</span></b></i>
  </a>
   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
     ...
     %>
      ...
      <li class="nav-item active  ml-5">
        <a class="nav-link" href="adminregister"><b><span class="text-color">Register New Admin</span></b><span class="sr-only">(current)</span></a>
      </li>
      ...
      <li class="nav-item active  ml-5">
        <a class="nav-link" href="accounttransfer"><b><span class="text-color">Fund Transfer</span></b><span class="sr-only">(current)</span></a>
      </li>
      
      <li class="nav-item active  ml-5" data-toggle="modal" data-target=".balancemodal">
        <a class="nav-link" href="#"><b><span class="text-color">Balance</span></b><span class="sr-only">(current)</span></a>
      </li>
...
<div class="modal fade history" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  ...
  <tbody>
    ...
    <%
	   ...
	   accountTransactions.sort(Comparator.comparing(AccountTransaction::getDate).reversed());
    ...
    function filterTransactions() {
        ...
        for (var i = 1; i < rows.length; i++) {
            var dateColumn = new Date(rows[i].getElementsByTagName("td")[4].textContent); // Adjust the index for the date column
