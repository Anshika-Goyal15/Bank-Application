       ...
       <div class="col-md-4 offset-md-4" >
            ...
            <form action="logincustomer" method="post">
                 ...
                 <div class="form-group">
                     ...
                     <input type="email" class="form-control" id="username" aria-describedby="emailHelp" name="emailId" placeholder="Enter email.." required>
                 </div>
                ...
                <div class="container text-center">
                      ...
                      <p>Not having an account?<a href="/customerregister">Register Here!!</a></p>
                </div>
